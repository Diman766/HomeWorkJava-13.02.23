...
public class View {
    ...
    public static void view() {
        ...
        step++;
        Main.twoTeam.forEach((v) -> l[0] = Math.max(l[0], v.toString().length()));
        System.out.print("_".repeat(l[0] * 2));
        System.out.println("");
        System.out.print(top10 + "  ");
        System.out.print("Blue side");
        // for (int i = 0; i < l[0]-9; i++)
        System.out.print(" ".repeat(l[0] - 12));
        System.out.println(":\tGreen side");
        for (int i = 1; i < 11; i++) {
            System.out.print(getChar(1, i));
        }
        System.out.print("|  ");
        System.out.print(Main.red.get(0));
        tabSetter(Main.red.get(0).toString().length(), l[0] - 3);
        System.out.println(Main.blue.get(0));
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|  ");
            System.out.print(Main.red.get(i - 1));
            tabSetter(Main.red.get(i - 1).toString().length(), l[0] - 3);
            System.out.println(Main.blue.get(i - 1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|  ");
        System.out.print(Main.red.get(9));
        tabSetter(Main.red.get(9).toString().length(), l[0] - 3);
        System.out.println(Main.blue.get(9));
